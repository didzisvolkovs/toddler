								...
								foreach($productdata as $data){
									if($data['name'] !=''){
											...
											// if (!$json) {
												...
												$this->cart->add($product_id, $quantity, $option, $recurring_id, $dropshipper_option);
												 ...
												 $json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $product_id), '',$this->url->link('checkout/cart'));
			...
			foreach($this->request->post['data'] as $data){
				...
				if ($product_info) {
					...
					if (!$json) {
						...
						$this->cart->add($data['product_id'], $quantity, $option, $recurring_id);

						$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product', 'product_id=' . $data['product_id']), $product_info['name'], $this->url->link('checkout/cart'));
						...
						$json['redirect'] = str_replace('&amp;', '&', $this->url->link('product/product', 'product_id=' . $data['product_id']));
					}
				}
