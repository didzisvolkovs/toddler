<?php
// Heading
$_['heading_title']          = 'Info Categories';

// Text
$_['text_success']           = 'Success: You have modified categories!';
$_['text_list']              = 'Info Category List';
$_['text_add']               = 'Add Info Category';
$_['text_edit']              = 'Edit Info Category';
$_['text_default']           = 'Default';
$_['text_keyword']           = 'Do not use spaces, instead replace spaces with - and make sure the SEO URL is globally unique.';

// Column
$_['column_name']            = 'Info Category Name';
$_['column_sort_order']      = 'Sort Order';
$_['column_action']          = 'Action';

// Entry
$_['entry_name']             = 'Info Category Name';
$_['entry_description']      = 'Description';
$_['entry_meta_title'] 	     = 'Meta Tag Title';
$_['entry_link'] 	           = 'Link (headingtitle = h4)';
