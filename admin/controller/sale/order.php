...
class ControllerSaleOrder extends Controller {
	...
	$json = array();
		$manfuacturer_id = $this->request->post['product_id'];

		$this->load->model('catalog/product');
		$results = $this->model_catalog_product->getProductsByManufacturerId($manfuacturer_id);
  ...
  // die();
			...
			$this->model_sale_order->updateGifts($order_id, $data);
...
// $this->model_catalog_product->addProduct($this->request->post);
	...
	public function savegifts() {
		...
		// die();
			...
			$this->model_sale_order->saveGifts($order_id, $data);
		// foreach ($this->request->post['gift_product_id'] as $key => $value) {
		// 	$this->model_sale_order->saveGifts($value,$order_id);
		// }
			//$this->response->setOutput($this->load->view('sale/order_info', $data));
			$this->response->redirect($this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . $url, true));
// $this->model_catalog_product->addProduct($this->request->post);
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['action'] = $this->url->link('sale/order/savegifts', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . (int)$this->request->get['order_id'], true);
			$data['action_update'] = $this->url->link('sale/order/updategifts', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . (int)$this->request->get['order_id'], true);
			...
			//dabuujam brendu sarakstu
				$this->load->model('catalog/manufacturer');

				$manufacturers = $this->model_catalog_manufacturer->getAllManufacturers();
...
//var_dump($order_info);
			 ...
			 if (isset($order_info['gift_discount'])) {
			 	$data['config_gift'] = $order_info['gift_discount'];
			 } else {
